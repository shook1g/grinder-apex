...
constexpr long OFF_TRAVERSAL_START_TIME = 0x2ad0;             //[Buttons]->m_traversalStartTime
constexpr long OFF_TRAVERSAL_PROGRESS = 0x2acc;               //[Buttons]->m_traversalProgress
constexpr long OFF_WALL_RUN_START_TIME = 0x355c;              //[Buttons]->m_wallRunStartTime
constexpr long OFF_WALL_RUN_CLEAR_TIME = 0x3560;              //[Buttons]->m_wallRunClearTime
...
constexpr long OFF_TIME_BASE = 0x2068;                        //[RecvTable.DT_Player]->m_currentFramePlayer.timeBase
